...
const WelcomeModal: React.FC<WelcomeModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className="bg-white rounded-2xl shadow-2xl w-full max-w-lg border border-[#e5e5e5]"
        ...
        <div className="px-6 pt-6 pb-4 flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h2 className="text-[20px] font-semibold text-[#0a0a0a] tracking-[-0.01em]">
                  Welcome{userName ? `, ${userName}` : ''}
                </h2>
                <p className="text-[13px] text-[#666] mt-0.5">Let's get you started</p>
              </div>
            </div>
          </div>
          <button
            onClick={onClose}
            className="p-1.5 hover:bg-[#f5f5f5] rounded-lg transition-colors text-[#999] hover:text-[#0a0a0a]"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <div className="px-6 pb-6">
          ...
          <div className="space-y-2 mb-6">
            <button
              ...
              className="w-full flex items-center gap-3 p-3.5 rounded-xl border border-[#e5e5e5] hover:border-[#ccc] hover:bg-[#fafafa] transition-all text-left group"
            >
          ...
          <div className="mt-6 flex items-center gap-3">
            <button
              ...
              className="flex-1 px-4 py-2.5 text-[13px] font-medium text-white bg-[#0a0a0a] rounded-xl hover:bg-[#262626] transition-colors flex items-center justify-center gap-2"
            >
              <Sparkles size={14} />
              Try Demo
            </button>
            <button
              onClick={onClose}
              className="px-4 py-2.5 text-[13px] font-medium text-[#666] hover:bg-[#f5f5f5] rounded-xl transition-colors"
            >
              Explore
            </button>
          </div>
